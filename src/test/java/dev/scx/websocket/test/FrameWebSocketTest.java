...
import static dev.scx.websocket.frame.WebSocketOpCode.CLOSE;
...
public class FrameWebSocketTest {
    ...
    static void startServer() throws IOException {
        ...
        Thread.ofPlatform().start(() -> {
            try {
                ...
                var scxFrameWebSocket = ScxFrameWebSocket.of(new TestSocketEndpoint(socket), false);
    ...
    static void startClient() throws IOException, WebSocketIOException, WebSocketProtocolException {
        ...
        try {
            socket.connect(new InetSocketAddress(8881));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }

        var scxFrameWebSocket = ScxFrameWebSocket.of(new TestSocketEndpoint(socket), true);
