...
/// WebSocketCloseInfoHelper
///
/// @author scx567888
/// @version 0.0.1
final class WebSocketCloseInfoHelper {

    public static WebSocketCloseInfo parseCloseInfo(byte[] frame) throws IllegalArgumentException {
        int len = frame.length;

        // 1, 允许空帧
        if (len == 0) {
            // 空 CloseInfo
            return new WebSocketCloseInfo(null, null);
        }
        ...
        return new WebSocketCloseInfo(code, reason);
    }

    public static byte[] toClosePayload(WebSocketCloseInfo closeInfo) throws IllegalArgumentException {
